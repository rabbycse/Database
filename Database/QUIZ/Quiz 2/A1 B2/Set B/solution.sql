Q1[10 Points]: Display employees whose salary is below the average salary of his/her department.
...
Q2[10 Points]: For each employee, Find the total number of employees who were hired before him/her
and who were hired after him/her. Print employee's last name, total employees hired before him/her, and
total employee's hired after him/her.
Ans: 
...
Q3[10 Points]: Find the last names of employees and their salaries for the top four highest salaried
employees. The number of employees in your output should be more than four if there are employees with
same salary.
Ans:
...
Q5[10 Points]: Find the last names and salaries of those employees whose salary is within 4000 of
the average salary of IT department.
